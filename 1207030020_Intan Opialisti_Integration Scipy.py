...
Original file is located at
    https://colab.research.google.com/drive/1dUGb__ohReZ3QncLZSUqX8RUfbBINoak
"""
...
y_values = 3*x_values**6-4*x_values*np.exp(-x_values)

# Plot the function curve.
plotlib.plot(x_values, y_values)

# Define a lambda function for integration over x values.
integration_function = lambda x: 3*x**6-4*x*np.exp(-x)
